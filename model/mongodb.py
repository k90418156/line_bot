...
def constructor_stock():
    client=MongoClient('mongodb://sln95302:Ss10260301@ac-93swz5b-shard-00-00.zosnptn.mongodb.net:27017,ac-93swz5b-shard-00-01.zosnptn.mongodb.net:27017,ac-93swz5b-shard-00-02.zosnptn.mongodb.net:27017/?ssl=true&replicaSet=atlas-tmntzm-shard-0&authSource=admin&retryWrites=true&w=majority')
    db=client[stockDB]
    return db
##########更新暫存的股票名稱##########
